...
public class Runner {
    public static void main(String[] args) throws Exception {
        ...
        // Target Java 17 bytecode so libraries that read class files with their
        // own (older) ASM (e.g. Spring) can parse the user's classes.
